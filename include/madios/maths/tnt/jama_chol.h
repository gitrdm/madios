...
public:
	...
	const TNT::Array2D<Real>& getL() const;
...
*/
template <class Real>
const TNT::Array2D<Real>& Cholesky<Real>::getL() const
{
	return L_;
}
...
*/
template <class Real>
TNT::Array1D<Real> Cholesky<Real>::solve(const TNT::Array1D<Real> &b) const
{
	int n = L_.dim1();
	assert (b.dim1() == n);
...
*/
template <class Real>
TNT::Array2D<Real> Cholesky<Real>::solve(const TNT::Array2D<Real> &B) const
{
	int n = L_.dim1();
	assert (B.dim1() == n);
